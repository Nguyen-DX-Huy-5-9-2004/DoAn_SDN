...
raw_target = sys.argv[1] if len(sys.argv) > 1 else "10.0.0.11"
target_ip = raw_target.replace("http://", "").replace("https://", "").split("/")[0]

# 2. CHỌN CỔNG (Mặc định 80 để đâm thẳng vào Web1, né Proxy Nginx)
